...
class ToastContainer extends Component {
    ...
    constructor() {
        ...
        if (this.props.customAnimation) {
            this.state.animatedValue = this.props.customAnimation.animatedValue;
            this.state.animatedStyle = this.props.customAnimation.animatedStyle(this.props.customAnimation.animatedValue);
    ...
    _show = () => {
        ...
        if (!this._animating) {
            ...
            let showAnimation = Animated.timing(this.state.opacity, {
            ...
            if (this.props.customAnimation) {
                showAnimation = this.props.customAnimation.showAnimation(this.props.customAnimation.animatedValue);
            }
    ...
    _hide = () => {
        ...
        if (!this._animating) {
            ...
            let hideAnimation = Animated.timing(this.state.opacity, {
                toValue: 0,
                duration: this.props.animation ? TOAST_ANIMATION_DURATION : 0,
            ...
            if (this.props.customAnimation) {
                hideAnimation = this.props.customAnimation.hideAnimation(this.props.customAnimation.animatedValue);
            }
